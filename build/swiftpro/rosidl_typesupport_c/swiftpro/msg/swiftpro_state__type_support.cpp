...
static const _SwiftproState_type_support_symbol_names_t _SwiftproState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, swiftpro, msg, SwiftproState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, swiftpro, msg, SwiftproState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, swiftpro, msg, SwiftproState)() {
  return &::swiftpro::msg::rosidl_typesupport_c::SwiftproState_message_type_support_handle;
}
