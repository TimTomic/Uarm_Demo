...
{
  new (message_memory) swiftpro::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<swiftpro::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[1] = {
  {
    ...
    offsetof(swiftpro::msg::Status, status),  // bytes offset in struct
...
{
  return &::swiftpro::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, swiftpro, msg, Status)() {
  return &::swiftpro::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
