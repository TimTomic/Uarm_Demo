...
#include "swiftpro/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swiftpro::msg::Position;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const swiftpro::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swiftpro::msg::Position *>(
    untyped_ros_message);
...
{
  return &swiftpro::msg::typesupport_fastrtps_cpp::_Position__handle;
}
