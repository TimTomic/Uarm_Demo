...
#include "swiftpro/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swiftpro::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swiftpro::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swiftpro::msg::Status *>(
    untyped_ros_message);
...
{
  return &swiftpro::msg::typesupport_fastrtps_cpp::_Status__handle;
}
